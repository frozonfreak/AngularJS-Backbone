var angularApp = angular.module('angularApp',['ui.bootstrap','ui.router','ngAnimate', 'ngCookies', 'ngResource','ngSanitize','ngTouch']).run(function($rootScope){
